...
// {
    ...
    $data_entry = true;//is_data_entry();

    $hijri_year = 1447;//get_current_hijri_year();
    $url = $dao->home_uri;//getAppData('BASE_URI');
    ?>
    <div class="row">
        <?php
        //superadmin, reception and data entry 
        if ($this->is_user_a(SUPER_ADMIN, RECEPTION, DATA_ENTRY)) { ?>
        ...
        if ($this->is_user_a(SUPER_ADMIN, TAKHMEENER)) { ?>
            <div class="col-md-4 col-sm-6 col-12">
