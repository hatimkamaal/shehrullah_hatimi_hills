...
<form method="post" action="">
    ...
    <input type="hidden" value="<?= $dao->its_data->hof_id ?>" name="hof_id" id="hof_id">
    <div class='col-xs-12'>
        <div class="mb-3 row">
            <label for="staticEmail" class="col-sm-3 col-form-label">HOF ID</label>
            <div class="col-sm-9">
                <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?= $dao->its_data->hof_id ?>">
            </div>
        </div>
        <!-- <div class="mb-3 row">
