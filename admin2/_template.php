...
$hijri = 1446;//get_current_hijri_year() ?? 0;
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <?php if ($header) { ?>
            <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                    ...
                    <a class="navbar-brand brand-logo-mini" href="<?= $homepage ?>">HH.M</a>
                </div>
                        ...
                        <li class="nav-item nav-profile dropdown">
                            ...
                            <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                             ...
                             <a class="dropdown-item" href="<?= $url ?>/admin">
                                <i class="mdi mdi-logout me-2 text-primary"></i> Admin </a>
                                <div class="dropdown-divider"></div>
                                <?php } ?>
                                <a class="dropdown-item" href="<?= $homepage ?>/logoff">
            ...
            <footer class="footer">
                <div class="container-fluid d-flex justify-content-between">
                    <span class="text-muted d-block text-center text-sm-start d-sm-inline-block">Copyright ©
                        Hatim</span>
                    <span class="float-none float-sm-end mt-1 mt-sm-0 text-end">Shehrullah</span>
                </div>
            </footer>
        <?php } ?>
