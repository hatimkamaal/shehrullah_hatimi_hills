...
function __handle_post()
{
    ...
    if ($action === 'register') {
        ...
        if( $receipt_num == -1 ) {
            ...
            do_redirect_with_message('/home', "Receipt created : <a target='receipt' href='$uri/receipt/$receipt_num'>Click here for receipt print.</a>");
...
function content_display()
{
    ...
    <form method="post">
        ...
        <div class='col-xs-12'>
            ...
            <div class="mb-3 row">
                <label for="hof_id" class="col-sm-3 col-form-label">Pending</label>
                <div class="col-sm-9">
                    <input type="text" readonly class="form-control" 
